...
class PaperTrading(ExchangeBase):
    ...
    def __init__(self, initial_balance: float = 100000.0):
        ...
        self.positions: Dict[str, Position] = {}  # {symbol: position_data}
    ...
    async def place_order(
        ...
        **kwargs,
        ...
        if price is None or order_type == "market":
            price = await self.get_current_price(symbol)[symbol]
    ...
    async def execute_sell(
        ...
        **kwargs,
        ...
        if self.positions[symbol].quantity < quantity:
            logger.warning(
                f"Insufficient position: have {self.positions[symbol].quantity:,.2f} {symbol}, "
